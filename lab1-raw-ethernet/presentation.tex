...
\begin{frame}{3. Layer 2 / Layer 3 Wireshark Packet Analysis}
    ...
    \begin{itemize}\scriptsize
        ...
        \item \textbf{Layer 3/4 Header (28B)}: IPv4 \texttt{10.0.0.1} $\rightarrow$ \texttt{10.0.0.2} (20B), ICMP Type 8 (Echo Request, Code 0, 8B).
...
% ==========================================
% SLIDE 7: SW-to-HW Correlation (Layer 4 ICMP & Payload)
% ==========================================
