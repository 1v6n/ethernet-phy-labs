...
\begin{columns}[c]
    ...
    \begin{column}{0.50\textwidth}
        \centering
        \imageframe{\includegraphics[width=0.96\linewidth, height=0.64\textheight, keepaspectratio]{figures/screenshot1_terminal.png}}
        \vspace{1mm}
...
\begin{frame}{3. Layer 2 / Layer 3 Wireshark Packet Analysis}
    ...
    \begin{itemize}\scriptsize
        ...
        \item \textbf{Layer 3 Header (28B)}: IPv4 \texttt{10.0.0.1} $\rightarrow$ \texttt{10.0.0.2} (20B, Len 84B, ID \texttt{0x7E53}), ICMP Type 8 (Echo Request, Code 0, Checksum \texttt{0xECEC}, ID \texttt{0x4702}, Seq 1).
    ...
    \vspace{1mm}
    \begin{center}
        \imageframe{\includegraphics[width=0.94\textwidth, height=0.45\textheight, keepaspectratio]{figures/screenshot2_wireshark.png}}
        \vspace{1mm}
...
\begin{frame}{4. XGMII Framing: Frame Start Delimiter \& Preamble}
    ...
    \vspace{1mm}
    \begin{center}
        \imageframe{\includegraphics[width=0.94\textwidth, height=0.45\textheight, keepaspectratio]{figures/screenshot3_preamble_start.png}}
        \vspace{1mm}
...
\begin{frame}{5. SW-to-HW Correlation: Layer 2 \& Layer 3 Headers}
    ...
    \vspace{1mm}
    \begin{center}
        \imageframe{\includegraphics[width=0.94\textwidth, height=0.45\textheight, keepaspectratio]{figures/screenshot4_headers_correlation.png}}
        \vspace{1mm}
...
\begin{frame}{6. SW-to-HW Correlation: Multi-Lane Payload (\texttt{0xCAFE0002})}
    ...
    \vspace{1mm}
    \begin{center}
        \imageframe{\includegraphics[width=0.94\textwidth, height=0.45\textheight, keepaspectratio]{figures/screenshot5_payload_correlation.png}}
        \vspace{1mm}
...
\begin{frame}{7. Frame Termination (\texttt{/T/}) \& FCS (CRC-32) Validation}
    ...
    \vspace{1mm}
    \begin{center}
        \imageframe{\includegraphics[width=0.94\textwidth, height=0.45\textheight, keepaspectratio]{figures/screenshot6_termination_fcs.png}}
        \vspace{1mm}
...
\begin{frame}{8. Pipeline Latency \& Register Timing Verification}
    ...
    \vspace{1mm}
    \begin{center}
        \imageframe{\includegraphics[width=0.94\textwidth, height=0.45\textheight, keepaspectratio]{figures/screenshot7_latency.png}}
        \vspace{1mm}
