...
\begin{frame}{4. XGMII Framing: Frame Start Delimiter \& Preamble}
    ...
    \vspace{1mm}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.48\textheight, keepaspectratio]{figures/screenshot3_preamble_start.png}
        \vspace{1mm}
...
\begin{frame}{5. SW-to-HW Correlation: Layer 2 \& Layer 3 Headers}
    ...
    \vspace{1mm}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.48\textheight, keepaspectratio]{figures/screenshot4_headers_correlation.png}
        \vspace{1mm}
...
\begin{frame}{6. SW-to-HW Correlation: Multi-Lane Payload (\texttt{0xCAFE0002})}
    ...
    \vspace{1mm}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.48\textheight, keepaspectratio]{figures/screenshot5_payload_correlation.png}
        \vspace{1mm}
...
\begin{frame}{7. Frame Termination (\texttt{/T/}) \& FCS (CRC-32) Validation}
    ...
    \vspace{1mm}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.48\textheight, keepaspectratio]{figures/screenshot6_termination_fcs.png}
        \vspace{1mm}
...
\begin{frame}{8. Pipeline Latency \& Register Timing Verification}
    ...
    \vspace{1mm}
    \begin{center}
        \includegraphics[width=0.98\textwidth, height=0.48\textheight, keepaspectratio]{figures/screenshot7_latency.png}
        \vspace{1mm}
